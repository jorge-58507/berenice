...
function ins_bh($date,$provider,$billnumber,$warehouse,$purchaseorder,$cpp,$preguardado){
	$link = conexion();
	$link->query("INSERT INTO bh_facturacompra (TX_facturacompra_fecha, facturacompra_AI_proveedor_id, TX_facturacompra_numero, TX_facturacompra_almacen, TX_facturacompra_ordendecompra, TX_facturacompra_status, facturacompra_AI_user_id, TX_facturacompra_preguardado)
		VALUES ('$date', '$provider', '$billnumber', '$warehouse', '$purchaseorder','$cpp','{$_COOKIE['coo_iuser']}'),'$preguardado'")or die($link->error);
