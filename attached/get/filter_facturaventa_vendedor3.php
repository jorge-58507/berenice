...
$qry_facturaventa_total = $link->query($txt_facturaventa)or die($link->error);
$total_no_credit=0;

while($rs_facturaventa_total = $qry_facturaventa_total->fetch_array()){
...
<table id="tbl_facturaventa" class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <?php switch($rs_facturaventa['datopago_AI_metododepago_id']){
					...
					case '2':	$color='#57afdb';	$total_cheque += $rs_facturaventa['TX_datopago_monto'];	break;
					case '3':	$color='#e9ca2f';	$total_tarjeta_credito += $rs_facturaventa['TX_datopago_monto'];	break;
					case '4':	$color='#f04006';	$total_tarjeta_debito += $rs_facturaventa['TX_datopago_monto'];	break;
					case '5':	$color='#b54a4a';	$total_credito += $rs_facturaventa['TX_datopago_monto'];	break;
					case '7':	$color='#EFA63F';	$total_notadc += $rs_facturaventa['TX_datopago_monto'];	break;
				}?>
