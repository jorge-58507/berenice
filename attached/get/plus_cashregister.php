...
$txt_devolucion="SELECT bh_notadecredito.AI_notadecredito_id,  bh_notadecredito.TX_notadecredito_destino, ROUND(bh_notadecredito.TX_notadecredito_monto+bh_notadecredito.TX_notadecredito_impuesto,2) AS NC, bh_notadecredito.TX_notadecredito_monto, bh_notadecredito.TX_notadecredito_impuesto
...
if ($cantidad_ff > 0) {
	...
	while($rs_base=$qry_base->fetch_array()){
		...
		echo $precio_descuento=$precio-$descuento;
...
//$base_ci = $base_ci + $nc_base;
//$ttl_impuesto=$ttl_impuesto-$nc_impuesto;


// echo "<br> CI: ".$base_ci." NI: ".$base_ni;
// echo "<br> Impuesto: ".$ttl_impuesto;
// echo "<br> Cantidad FF: ".$cantidad_ff;
...
$json_datodebito = json_encode($raw_debito);
	$txt_insert	=	"INSERT INTO bh_arqueo	(arqueo_AI_impresora_id, arqueo_AI_user_id, TX_arqueo_fecha, TX_arqueo_hora, TX_arqueo_pago, TX_arqueo_ventabruta, TX_arqueo_ventaneta, TX_arqueo_totalni, TX_arqueo_totalci, TX_arqueo_totalci_nc, TX_arqueo_impuesto, TX_arqueo_impuesto_nc, TX_arqueo_descuento, TX_arqueo_cantidadff, TX_arqueo_entrada, TX_arqueo_salida, TX_arqueo_devolucion, TX_arqueo_debito)	VALUES ('{$rs_impresoraid['AI_impresora_id']}', '{$_COOKIE['coo_iuser']}', '$fecha_actual', '$hora_actual', '$json_datopago', '$venta_bruta', '$venta_neta', '$base_ni', '$base_ci', '$nc_base', '$ttl_impuesto', '$nc_impuesto', '$ttl_descuento', '$cantidad_ff', '$ttl_entrada', '$ttl_salida', '$devolucion', '$json_datodebito')";
