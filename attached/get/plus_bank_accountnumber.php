...
$link->query("INSERT INTO bh_banconumero (TX_banconumero_nombre, TX_banconumero_value, banconumero_AI_user_id, banconumero_AI_banco_id, banconumero_AI_proveedor_id) VALUES ('$nombre','$numero','{$_COOKIE['coo_iuser']}','$banco_id','$proveedor_id')")or die($link->error);
