...
$medida = $_GET['g'];
	...
	$link->query("INSERT INTO bh_nuevacompra (nuevacompra_AI_user_id, nuevacompra_AI_producto_id, TX_nuevacompra_unidades, TX_nuevacompra_precio, TX_nuevacompra_itbm, TX_nuevacompra_descuento, TX_nuevacompra_p4, TX_nuevacompra_medida)
VALUES ('{$_COOKIE['coo_iuser']}','$id', '$cantidad', '$precio', '$impuesto', '$descuento','$p4','$medida')")or die($link->error);
