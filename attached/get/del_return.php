...
<?php }while($rs_nuevadevolucion=mysql_fetch_array($qry_nuevadevolucion)); ?>
    ...
    <tr>
        ...
        <span id="span_preciowdescuento"><?php echo number_format($total_precio,2); ?></span>$</td>
        <td>
        <label for="span_impuesto">Impuesto:</label><br />
        <span id="span_impuesto"><?php echo number_format($total_impuesto,2); ?></span>$</td>
        <td>
        <label for="span_totalnc">Total:</label><br />
        <span id="span_totalnc"><?php echo number_format($total_nc = $total_precio+$total_impuesto,2); ?></span>$</td>
    </tr>
    </tfoot>
    </table>