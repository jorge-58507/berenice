...
$new_price=$_GET['b'];
	...
	$qry_nuevaventa = $link->query("SELECT AI_nuevaventa_id FROM bh_nuevaventa WHERE nuevaventa_AI_producto_id = '$product_id' AND nuevaventa_AI_user_id = '{$_COOKIE['coo_iuser']}'")or die($link->error);
