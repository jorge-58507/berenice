...
$qry_provider = $link->query("SELECT cpp_AI_proveedor_id FROM bh_cpp WHERE AI_cpp_id = '$cpp_id'")or die($link->error);
$rs_provider =	$qry_provider->fetch_array();
$proveedor_id = $rs_provider['cpp_AI_proveedor_id'];

	$bh_del="DELETE FROM bh_cpp WHERE AI_cpp_id = '$cpp_id'";
