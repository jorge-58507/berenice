...
$qry_datodevolucion = $link->query("SELECT bh_datodevolucion.TX_datodevolucion_cantidad, bh_datodevolucion.TX_datodevolucion_medida, bh_datodevolucion.datodevolucion_AI_producto_id, bh_datodevolucion.datodevolucion_AI_datoventa_id,
	...
	<tr style="height:190px">
	    ...
	    <table id="tbl_client" class="table">
	    	...
	    	<table id="tbl_creditnote" class="table">
	    			...
	    			<tr>
	        		<td valign="top"><strong>Usuario(a): </strong><?php echo strtoupper($rs_creditnote['TX_user_seudonimo']); ?></td>
	        		<td valign="top"><strong>Fecha: </strong><?php echo $rs_creditnote['TX_notadecredito_fecha']; ?></td>
	            <td valign="top"><strong>Hora: </strong><?php echo $rs_creditnote['TX_notadecredito_hora']; ?></td>
	            <td></td>
	        	</tr>
	        	<tr>
	            <td valign="top"><strong>N&deg; N.C.: </strong><?php echo $rs_creditnote['TX_notadecredito_numero']; ?></td>
	            <td valign="top"><strong>N&deg; Factura: </strong><?php echo $rs_creditnote['TX_facturaf_numero']; ?></td>
	            <td valign="top"><strong>Retencion: </strong><?php echo $rs_creditnote['TX_notadecredito_retencion']."%"; ?></td>
	            <td valign="top"><strong>Monto: </strong><?php echo number_format($rs_creditnote['total'],2); ?></td>
			    	</tr>
						<tr>
							<td valign="top" colspan="3"><strong>Motivo: </strong><?php echo $rs_creditnote['TX_notadecredito_motivo']; ?></td>
							<td valign="top" colspan="3"><strong>Destino: </strong><?php echo $rs_creditnote['TX_notadecredito_destino']; ?></td>
						</tr>
					</tbody>
				</table>
	    </td>
		...
		<tr style="height:608px;">
    		...
    		<table  id="tbl_datoventa" class="table table-print table-bordered table-striped">
    			<thead style="border:solid">
    				<tr>
	            <th style="width:10%; text-align:center; border:solid 1px #000;"><strong>Cantidad</strong></th>
							<th style="width:20%; text-align:center; border:solid 1px #000; border-bottom-left-radius:3px;border-top-left-radius:3px;"><strong>Codigo </strong></th>
	            <th style="width:50%; text-align:center; border:solid 1px #000;"><strong>Descripcion </strong></th>
							<th style="width:50%; text-align:center; border:solid 1px #000;"><strong>Medida </strong></th>
            	<th style="width:10%; text-align:center; border:solid 1px #000;"><strong>Precio</strong></th>
	            <th style="width:10%; text-align:center; border:solid 1px #000; border-bottom-right-radius:3px;border-top-right-radius:3px;"><strong>Total. </strong></th>
						</tr>
					</thead>
    			<tbody>
<?php 			$subtotal=0;	$totalitbm=0;	$totaldescuento=0;	$index = 1;	$pager = 0;
				...
				<tr style="height:580px;">
					<td valign="top" colspan="10" style="padding-top:2px;">
						<table  id="tbl_datoventa" class="table table-print table-bordered table-striped">
							<thead style="border:solid">
								<tr>
									<th style="width:10%; text-align:center; border:solid 1px #000;">Cantidad</th>
									<th style="width:15%; text-align:center; border:solid 1px #000;">Codigo</th>
									<th style="width:40%; text-align:center; border:solid 1px #000;">Descripcion</th>
									<th style="width:15%; text-align:center; border:solid 1px #000;">Medida</th>
			            <th style="width:10%; text-align:center; border:solid 1px #000;">Precio</th>
			            <th style="width:10%; text-align:center; border:solid 1px #000;">Total</th>
								</tr>
							</thead>
							<tbody>
<?php				}
		        ...
		        <td style="width:50%; text-align:center;">
						...
						<td>
							<?php echo $raw_medida[$rs_datodevolucion['TX_datodevolucion_medida']]; ?>
						</td>
<?php 			$qry_datoventa=$link->query("SELECT AI_datoventa_id, datoventa_AI_producto_id, TX_datoventa_medida, TX_datoventa_cantidad FROM bh_datoventa WHERE AI_datoventa_id = '{$rs_datodevolucion['datodevolucion_AI_datoventa_id']}'")or die($link->error);
						$rs_datoventa=$qry_datoventa->fetch_array();

						$rel_datodevolucion = get_rel_medida_cantidad($rs_datodevolucion['datodevolucion_AI_producto_id'],$rs_datodevolucion['TX_datodevolucion_medida']);
						...
						$retenido = ($rs_creditnote['TX_notadecredito_retencion']*$precio_descuento)/100;
						$precio_descuento_retenido = $precio_descuento-$retenido;
						$impuesto=($precio_descuento_retenido*$rs_datodevolucion['TX_datoventa_impuesto'])/100;
						$precio_descuento_impuesto=($precio_descuento_retenido+$impuesto)*$rel_coheficiente;
?>	        <td style="width:10%; text-align:center;">
<?php					echo number_format($precio_descuento_impuesto,4);	?>
		        </td>
		        <td style="width:10%; text-align:center;">
<?php					$subtotal = $precio_descuento_impuesto*($rs_datodevolucion['TX_datodevolucion_cantidad']);
