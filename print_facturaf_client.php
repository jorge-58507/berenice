...
$qry_facturaf=mysql_query($txt_facturaf.$line_deficit.$line_order) or die(mysql_error());
    	...
    	<tr style="height:30px;">
            ...
            <td>
				<?php echo number_format($base_ni = round($rs_facturaf['TX_facturaf_subtotalni'],2)+round($rs_facturaf['TX_facturaf_descuentoni'],2),2); ?>
            </td>
            <td>
				<?php echo number_format($rs_facturaf['TX_facturaf_descuentoni'],2); ?>
            </td>
            <td>
				<?php echo number_format($base_i = round($rs_facturaf['TX_facturaf_subtotalci'],2)+round($rs_facturaf['TX_facturaf_descuento'],2),2); ?>
            </td>
            <td>
				<?php echo number_format($rs_facturaf['TX_facturaf_descuento'],2); ?>
            </td>
            <td>
