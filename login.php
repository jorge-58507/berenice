...
<?php
    ...
    $txt_checkpass="SELECT AI_user_id,TX_user_type,TX_user_seudonimo FROM bh_user WHERE TX_user_password = '$pass' AND TX_user_activo = '1'";
    $exe_checkpass=$link->query($txt_checkpass)or die($link->error);
