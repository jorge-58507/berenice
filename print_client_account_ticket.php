...
$qry_facturaf = $link->query("SELECT bh_facturaf.AI_facturaf_id, bh_facturaf.TX_facturaf_fecha, bh_facturaf.TX_facturaf_hora, bh_facturaf.TX_facturaf_numero, bh_facturaf.TX_facturaf_ticket,
	...
	<div id="print_body" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding">
		...
		foreach ($raw_ff_included as $key => $rs_facturaf_debito) {
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding print_line_body">
				...
				<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 al_center"><?php echo $rs_facturaf_debito['TX_facturaf_ticket']; ?></div>
