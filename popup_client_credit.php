...
$("#btn_filter").on("click",function(){
	...
	$.ajax({
		data: {"a" : <?php echo $client_id; ?>,"b" : $("#txt_datei").val(),"c" : $("#txt_datef").val(),"d" : $("#sel_deficit").val()}, type: "GET", dataType: "text", url: "attached/get/filter_client_deficit.php",
	})
	.done(function( data, textStatus, jqXHR ) {
...
<div id="container_credit" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	...
	<div id="container_saldo" class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
		...
		<div id="container_btnconvertsaldo" class="col-xs-3 col-sm-3 col-md-3 col-lg-3 side-btn-md">
