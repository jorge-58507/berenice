...
$("#btn_printcompra").on("click",function(){
	...
	var	limit = $("input[name=r_limit_purchased]:checked").val();
...
$("#txt_filterproduct").on("keyup", function(){
	var limit = ($("input[name=r_limit_sold]:checked").val());
...
<div class="tab-content">
	...
	<div id="purchased" class="container-fluid no_padding tab-pane fade in active" >
		<div id="container_product" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		  ...
		  <div id="container_filter_limitproduct" class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
		    <label class="label label_blue_sky"for="txt_filterproduct">Mostrar:</label><br />
				<label class="radio-inline pt_7"><input type="radio" name="r_limit_purchased" id="r_limit_purchased" value="10" checked="checked"/> 10</label>
				<label class="radio-inline pt_7"><input type="radio" name="r_limit_purchased" id="r_limit_purchased" value="50" /> 50</label>
				<label class="radio-inline pt_7"><input type="radio" name="r_limit_purchased" id="r_limit_purchased" value="" /> Todas</label>
			</div>
	...
	<div id="sold" class="container-fluid no_padding tab-pane fade">
		...
		<label class="radio-inline pt_7"><input type="radio" name="r_limit_sold" id="r_limit_sold" value="10" checked="checked"/> 10</label>
		<label class="radio-inline pt_7"><input type="radio" name="r_limit_sold" id="r_limit_sold" value="50" /> 50</label>
		<label class="radio-inline pt_7"><input type="radio" name="r_limit_sold" id="r_limit_sold" value="" /> Todas</label>
			</div>
			<div id="container_date" class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
				<div id="container_txtdateinitial" class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
						<label class="label label_blue_sky"  for="txt_date_initial">F. Inicio</label>
		...
		<div id="container_facturaf" class="col-xs-12 col-sm-12 col-md-12 col-lg-12 no_padding pt_7">
