...
if(isset($_GET['a'])){
	...
	$insert_new_purchase = $link->prepare("INSERT INTO bh_nuevacompra (nuevacompra_AI_user_id, nuevacompra_AI_producto_id, TX_nuevacompra_unidades, TX_nuevacompra_precio, TX_nuevacompra_itbm, TX_nuevacompra_descuento) VALUES ('{$_COOKIE['coo_iuser']}', ?, ?, ?, ?, '0')")or die($link->error);
...
<div id="container_purchaseorder" class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
    <label for="txt_purchaseorder">Orden de Compra:</label>
...
<div id="container_observation" class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
	<label for="ta_observation">Observaciones</label><span id="span_taobservation" class="span_counter">200</span>
