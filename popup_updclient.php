...
$('#btn_acept').click(function(){
	...
	if($("#txt_cif").val() != "" && $("#txt_cif").val().length < '7'){	$("#txt_cif").focus();	return false;	}
	...
	$.ajax({	data: { "a" : name, "b" : $("#txt_cif").val(), "c" : $("#txt_telephone").val(), "d" : $("#txt_direction").val(), "e" : '<?php echo $client_id; ?>', "f" : activo },	type: "GET",	dataType: "text",	url: "attached/get/upd_client_info.php", })
