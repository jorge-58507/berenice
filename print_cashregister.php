...
<tr style="height:45px" align="center">
    ...
    <span style="font-size:14px; font-weight: bolder;"><?php echo strtoupper($host_name); ?> Arqueo de Caja #<?php echo $nr_chkarqueo; ?></span>
		<?php
...
<tr style="height:606px">
    ...
    <table align="center" border="1" cellpadding="0" cellspacing="0" style="width:100%; font-size:12px; text-align:center;">
    	<thead>
        <tr>
        	<th style="width:100%" colspan="2"><strong>TOTALES</strong></th>
    	</tr>
        </thead>
        <tbody>
        <tr>
