...
<tr style="height:6px">
<td width="10%"><img src="attached\image\scan.jpg" width='720px' style="position: absolute; z-index: -2; margin-top: -7px;"></img></td>
<td width="10%"></td>
<td width="10%"></td>
<td width="10%"></td>
<td width="10%"></td>
...
<tr style="height:76px;" align="right">
	<td valign="top" colspan="10" class="optmayuscula" style="vertical-align: bottom;">
		<div style="width:433px; float:left;"> &nbsp;</div>
		<div style="width:224px; float:left; letter-spacing: 13.5px;"><?php echo date('dmY',strtotime($fecha)); ?></div>
		<div style="width:28px; float:left;"> &nbsp;</div>
  </td>
</tr>
<tr style="height:58.8px" align="center">
	<td valign="top" colspan="10">
		<div style="width:123.37px; float:left;"> &nbsp;</div>
		<div style="width:413.57px; float:left;">**<?php echo $rs_cheque['TX_proveedor_nombre']; ?>**</div>
		<div style="width:154.73px; float:left;"><?php echo $rs_cheque['TX_cheque_monto']; ?></div>
		<div style="width:28px; float:left;"> &nbsp;</div>
  </td>
</tr>
<tr style="height:40px" align="center">
	<td valign="top" colspan="10">
		<div style="width:123.37px; float:left;"> &nbsp;</div>
		<div style="width:413.57px; float:left;">**<?php echo $rs_cheque['TX_cheque_montoletra']; ?>**</div>
		<div style="width:182.73px; float:left;"> &nbsp;</div>
  </td>
</tr>
<tr style="height:283.3px">
	<td valign="top" colspan="10">&nbsp;</td>
</tr>
<tr style="height:28.93px">
	<td valign="top" colspan="10">
		<div style="width:123.37px; float:left;"><?php echo date('d-M-y',strtotime($fecha_actual)); ?></div>
		<div style="width:263.95px; float:left;"><?php echo $rs_cheque['TX_cheque_observacion']; ?></div>
		<div style="width:149.62px; float:left;">&nbsp;</div>
		<div style="width:154.73px; float:left;"><?php echo $rs_cheque['TX_cheque_monto']; ?></div>
  </td>
</tr>
<tr style="height:461.27px">
	<td colspan="10"></td>
</tr>
</table>
</body>
