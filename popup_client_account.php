...
$txt_facturaf="SELECT
bh_facturaf.AI_facturaf_id, bh_facturaf.TX_facturaf_numero, bh_facturaf.TX_facturaf_ticket, bh_facturaf.TX_facturaf_fecha, bh_facturaf.TX_facturaf_subtotalni, bh_facturaf.TX_facturaf_subtotalci, bh_facturaf.TX_facturaf_impuesto, bh_facturaf.TX_facturaf_descuento, bh_facturaf.TX_facturaf_deficit
FROM bh_facturaf
	...
	<div id="main" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	    ...
	    <div id="container_tblfacturaf" class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
	        ...
	        <thead class="bg-primary">
		        <tr>
		        	<th>Numero</th><th>Fecha</th><th>Imp</th><th>Total</th><th>Deficit</th>
		        </tr>
	        </thead>
