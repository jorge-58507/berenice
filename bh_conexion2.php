...
class recurrent_function{
	public function replace_special_character($str){
		$to_replace = array("&ampersand;","&Aacute;","&Eacute;","&Iacute;","&Oacute;","&Uacute;","&Ntilde;","&aacute;","&eacute;","&iacute;","&oacute;","&uacute;","&nolger;","&squote;","&squote;&squote;","&deg;","&ntilde;","\'","laremun;");
